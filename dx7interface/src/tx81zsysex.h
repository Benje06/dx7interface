 ...
 */
 /*
  * Created from table ods of tx81z's sysex structure
  */
...
typedef struct st_tx81zsysex_1 {
	St_op op[4];
	St_pitch pitch;
	St_algo algo;
	St_lfo lfo;
...
template <guint i>
struct St_tx81zsysex{
	St_tx81zsysex_1 sound[i];
};

/*typedef struct st_tx81zsysex_32{
	St_tx81zsysex sound[32];
}St_tx81zsysex_32;

typedef struct St_tx81zsysex_128{
	St_tx81zsysex sound[128];
}St_tx81zsysex_128;
*/
#endif /* tx81zsysex_H */
